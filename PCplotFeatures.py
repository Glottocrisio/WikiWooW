...
def create_parallel_coordinates_plot(df, output_filename):
    ...
    column_map = {
        'Clickstream': ['ClickstreamEnt1Ent2', 'Clickstream'],
        ...
        'CosineSimilarity': ['CosineSimilarityEnt1Ent2', 'CosineSimilarity'],
        'DBpediaSimilarity': ['DBpediaSimilarityEnt1Ent2', 'DBpediaSimilarity'],
        'DBpediaRelatedness': ['DBpediaRelatednessEnt1Ent2', 'DBpediaRelatedness'],
